...
public class EmpApp {
    public static void main(String[] args) {
        ...
        System.out.println(totalYearSalary);
        
        // 7. 전체 직원 연봉+보너스의 합 (10%, 20%, 30%, 40%)
        ...
        System.out.println(totalYearSalaryWithBonus);
    }
}
